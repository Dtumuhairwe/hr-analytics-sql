...
-- Database: MySQL 8.x
-- Purpose: Create a normalized HR analytics database for employee,
--          salary, performance, department, and project analysis.
-- =====================================================================
...
CREATE TABLE salaries (
    ...
    CONSTRAINT uq_employee_salary_year
        UNIQUE (employee_id, salary_year),

    CONSTRAINT chk_salary_amounts
        CHECK (base_salary > 0 AND bonus >= 0)
);
...
CREATE TABLE performance_reviews (
    ...
    CONSTRAINT uq_employee_review_year
...
CREATE INDEX idx_salaries_employee_year
    ON salaries(employee_id, salary_year);

CREATE INDEX idx_reviews_employee_year
    ON performance_reviews(employee_id, review_year);
